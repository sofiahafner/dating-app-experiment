...
//           You will take part in Sofia's Thesis experiment etc etc etc
//         </p>
//       </div>
  ...
  return (
    <div className="mt-3 sm:mt-5 p-20">
      <div className="mt-2 mb-6">
        ...
        <p className="text-sm text-gray-500">
          The aim of this research is to better understand how users interact with recommendation systems in the context of dating apps.<br /><br />
          We appreciate your interest in participating in this online task and survey. Please read through this information before agreeing to participate (if you wish to) by ticking the ‘yes’ box below. <br /><br />
          You may ask any questions before deciding to take part by contacting the researcher (details below).<br /><br />
          The study is being conducted by Franziska Hafner, who is attached to the Oxford Internet Institute at the University of Oxford. This research is being completed under the supervision of Dr Luc Rocher.<br /><br />
        ...
        <p className="text-sm text-gray-500">
          We will not collect any data that could directly identify you.<br /><br />
          Your IP address will not be stored. We will take all reasonable measures to ensure that data remain confidential.<br /><br />
          The responses you provide will be stored in a password-protected electronic file on University of Oxford secure servers and may be used in academic publications or conference presentations. Research data will be stored for a minimum of 3 years after publication or public release of the work of the research. <br /><br />
        ...
        <p className="text-sm text-gray-500">
          The University of Oxford is the data controller with respect to your personal data and, as such, will determine how your personal data is used in the research. Research is a task that we perform in the public interest. Further information about your rights with respect to your personal data is available from https://compliance.admin.ox.ac.uk/individual-rights. <br /><br />
          We would like to use the data in future studies, and to share data with other researchers (e.g. in online databases). Data will have identifying information removed before it is shared with other researchers or results are made public.<br /><br />
